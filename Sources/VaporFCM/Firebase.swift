...
public class Firebase {
	...
	public func send(message: Message, to deviceToken: DeviceToken) throws -> FirebaseResponse {
		let requestBytes: Bytes = try serializer.serialize(message: message, device: deviceToken)
		do {
